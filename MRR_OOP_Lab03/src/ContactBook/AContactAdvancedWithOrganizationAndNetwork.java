...
abstract class AContactAdvancedWithOrganizationAndNetwork implements IContact {
    ...
    public AContactAdvancedWithOrganizationAndNetwork() {
        ...
        System.out.print("Начинаем создание нового контакта" + "\n" + "Введите имя : ");
        try {
        ...
        System.out.print("Введите организацию: ");
        try {
            Organisation = in.next();
        } catch (Exception e) {
            System.out.println("Неверный формат");
        }
        System.out.print("Введите привязан ли к номеру телеграм: Да/Нет ");
        try {
        ...
        System.out.print("Введите альтернативный номер: ");
        try {
